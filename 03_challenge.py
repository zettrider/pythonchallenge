'''
Challenge 3 von pythonchallenge.com
Aufgabe: http://www.pythonchallenge.com/pc/def/equality.html
Loesung: http://www.pythonchallenge.com/pcc/def/linkedlist.php
Naechste: http://www.pythonchallenge.com/pc/def/linkedlist.php
'''
...
mymatch = r"[a-z][A-Z]{3}([a-z])[A-Z]{3}[a-z]"
myfind = re.findall(mymatch, data)
#print(myfind)
print("".join(re.findall(mymatch, data)))